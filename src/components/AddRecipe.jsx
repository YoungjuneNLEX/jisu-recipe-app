...
- **설명란에 재료·분량·조리 순서가 구체적으로 적혀 있다면 그 내용을 최우선으로 반영**하세요. 설명란은 절대 무시하지 마세요 — 프레임에서 읽기 어려운 정확한 계량은 설명란 쪽을 따르고, 설명란에 없는 내용만 프레임에서 보충하세요.` : ''
...
- sauce: 양념/소스 재료만 분리 (간장, 고춧가루 등). 분량은 자막·설명란·프레임에서 실제로 확인된 값만 적으세요. 확인되지 않으면 재료명만 적거나 "적당량"으로 표기하고, 일반적인 조리 지식으로 비율을 지어내지 마세요. 없으면 []
- steps: 조리 순서를 구체적으로. 불 세기, 조리 시간(몇 분) 반드시 포함. 최소 5단계.
- note: 실패하지 않는 팁, 대체 재료, 주의사항
- 모든 항목(재료·분량·시간)은 자막/설명란/영상 프레임에서 실제로 확인된 내용만 적으세요. 확인 안 된 내용은 절대 추측해서 지어내지 마세요.`,
  }
