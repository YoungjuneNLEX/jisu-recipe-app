...
- sauce: 양념·소스 재료만. 분량은 캡션·이미지에서 실제로 확인된 값만 적으세요. 확인되지 않으면 재료명만 적거나 "적당량"으로 표기하고, 일반적인 조리 지식으로 비율을 지어내지 마세요. 없으면 []
- steps: 조리 순서 구체적으로, 불 세기·시간 포함, 최소 3단계
- note: 강조된 팁이나 주의사항
- 모든 항목(재료·분량·시간)은 캡션/이미지에서 실제로 확인된 내용만 적으세요. 확인 안 된 내용은 절대 추측해서 지어내지 마세요.`,
  }
