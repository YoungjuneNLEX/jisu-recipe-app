...
- sauce: 양념/소스 재료만 분리. 분량은 이미지에서 실제로 확인된 값만 적으세요. 확인되지 않으면 재료명만 적거나 "적당량"으로 표기하고, 일반적인 조리 지식으로 비율을 지어내지 마세요. 없으면 []
- steps: 조리 순서를 구체적으로. JSON 외 다른 말은 출력하지 마세요.
- 이미지에서 명확히 읽거나 추론 가능한 내용만 적으세요. 확인 안 된 내용은 지어내지 마세요.`
